...
#-----------------------------------
resource "azurerm_public_ip" "pip-orderlogix-00" {
  name                = "pip-orderlogix-00"
  resource_group_name = var.resource_group_name
...
resource "azurerm_application_gateway" "main" {
  ...
  frontend_ip_configuration {
    ...
    public_ip_address_id          = azurerm_public_ip.pip-orderlogix-00.id
  }
...
resource "azurerm_monitor_diagnostic_setting" "pip-diag" {
  ...
  target_resource_id         = azurerm_public_ip.pip-orderlogix-00.id
