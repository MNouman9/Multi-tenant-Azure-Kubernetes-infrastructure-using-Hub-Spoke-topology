...
variable "pip-fw-eastus-default" {
  description = "Specifies the firewall public IP name"
  type        = string
  default     = "pip-fw-eastus-default"
}
variable "pip-fw-eastus-01" {
  description = "Specifies the firewall public IP name"
  type        = string
  default     = "pip-fw-eastus-01"
}
variable "pip-fw-eastus-02" {
  description = "Specifies the firewall public IP name"
  type        = string
  default     = "pip-fw-eastus-02"
}
